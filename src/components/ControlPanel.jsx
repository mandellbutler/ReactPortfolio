...
const ControlPanel = (props) => {
  ...
  const firstPageClass = isFirstPage ? 'disabled' : 'cliackable';
  ...
  return (
    <div className="control-panel m-3 p-3 d-flex align-items-baseline justify-content-between">
      <div className="d-flex justify-content-between align-items-baseline">
        ...
        <span>
          Page <input name="pageNumber" type="number" min={1} max={numPages || 1} className="p-o pl-1 mx-2" value={pageNumber} onChange={onPageChange} />{''} of {numPages}
        </span>
